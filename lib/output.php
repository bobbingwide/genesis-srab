 ...
 *
 * This file adds the required CSS to the front end to the Genesis Solent Roofing and Building Theme.
 *
...
add_action( 'wp_enqueue_scripts', 'genesis_srab_css' );
/**
...
function genesis_srab_css() {
	...
	if ( $logo ) {
		...
		$logo_max_width        = get_theme_mod( 'genesis_srab_logo_width', 350 );
